...
export const SwitchCameraIcon = ({ width = 24, height = 24, color = '#000' }: IProps) => (
    <Svg width={scaleHorizontal(width)} height={scaleHorizontal(height)} viewBox="0 -960 960 960" fill={color}>

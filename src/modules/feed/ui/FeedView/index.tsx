        ...
        <ScreenContainer edges={['top']}>
            <View style={styles.container}>
                ...
                <View style={{ marginTop: 40, paddingHorizontal: 16 }}>
                    ...
                    <Typography text={`First half (0-50%): values 0-70`} variant="body_400" style={{ marginBottom: 4, opacity: 0.7 }} />
                    <Typography text={`Second half (50-100%): values 71-100`} variant="body_400" style={{ marginBottom: 16, opacity: 0.7 }} />
